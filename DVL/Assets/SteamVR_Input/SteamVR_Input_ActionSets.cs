...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Labyrinth p_Labyrinth;
        ...
        public static SteamVR_Input_ActionSet_Labyrinth Labyrinth
        {
            get
            {
                return SteamVR_Actions.p_Labyrinth.GetCopy<SteamVR_Input_ActionSet_Labyrinth>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Labyrinth = ((SteamVR_Input_ActionSet_Labyrinth)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Labyrinth>("/actions/Labyrinth")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Labyrinth};
        }
    }
}
