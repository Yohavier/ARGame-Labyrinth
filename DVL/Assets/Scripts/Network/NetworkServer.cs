...
public class NetworkServer
{
    ...
    public void SetupServer()
    {
        ...
        serverSocket.Bind(new IPEndPoint(IPAddress.Loopback, 3999));
    ...
    private void BroadcastMessage(byte[] data)
    {
        ...
        {
            clientList[i].clientSocket.BeginSend(data, 0, data.Length, SocketFlags.None, new AsyncCallback(SendCallback), clientList[i]);
        }
    }
